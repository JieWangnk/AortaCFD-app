...
class TestConfigCaseInfo:
    ...
    def test_case_info_present(self):
        ...
        cfg = Config({"case_info": {"patient_id": "PAT001", "notes": "Test case"}})
...
class TestConfigGeometry:
    ...
    def test_outlet_names_string(self):
        ...
        cfg = Config({"geometry": {"outlet_keywords_ordered": "single_outlet"}})
...
class TestConfigInletSettings:
    ...
    def test_inlet_csv_settings(self):
        ...
        cfg = Config({"inlet": {"csv_file": "inlet_flow.csv", "data_type": "velocity"}})
    ...
    def test_inlet_profile_settings(self):
        ...
        cfg = Config({"inlet": {"profile": "wall_distance", "exponent": 7.0, "n_harmonics": 10}})
...
class TestConfigWindkesselSettings:
        ...
        cfg = Config(
            {
                "outlets": {
                    "type": "3EWINDKESSEL",
                    "windkessel_settings": {"systolic_pressure": 130, "diastolic_pressure": 85, "venous_pressure": 3},
                }
            }
        )
    ...
    def test_windkessel_flow_split(self):
        ...
        # Percentage
        cfg2 = Config({"outlets": {"windkessel_settings": {"flow_split": 60}}})
        assert cfg2.windkessel_flow_split == 60

        # Dict
        cfg3 = Config({"outlets": {"windkessel_settings": {"flow_split": {"outlet1": 0.4, "outlet2": 0.6}}}})
    ...
    def test_windkessel_outlet_parameters(self):
        ...
        cfg = Config(
            {"outlets": {"windkessel_settings": {"outlet_parameters": {"outlet1": {"R": 1e8, "C": 1e-9, "Z": 1e7}}}}}
        )
    ...
    def test_windkessel_pwv_settings(self):
        ...
        cfg = Config({"outlets": {"windkessel_settings": {"pwv_method": "fixed", "pwv": 8.5}}})
...
class TestConfigNumerics:
    ...
    def test_profile_and_max_co(self):
        ...
        cfg = Config({"numerics": {"profile": "robust", "max_co": 0.5}})
...
class TestConfigMesh:
    ...
    def test_mesh_settings(self):
        ...
        cfg = Config(
            {"mesh": {"refinement_level": 2, "boundary_layers": True, "SNAPPY_SETTINGS": {"maxLocalCells": 1000000}}}
        )
        mesh = cfg.get("mesh", {})
...
class TestConfigSimulation:
    ...
    def test_simulation_settings(self):
        ...
        cfg = Config({"simulation": {"end_time": 5.0, "num_processors": 8}, "cardiac_cycle": 0.85})
