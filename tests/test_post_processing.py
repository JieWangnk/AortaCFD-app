...
class TestPostProcessingConfig:
    ...
    def test_from_dict_minimal(self):
        ...
        data = {"case_dir": "/path/to/case", "cardiac_cycle": 1.0}
    ...
    def test_boundary_conditions_fallback(self):
        ...
        data = {"boundary_conditions": {"inlet": {"type": "TIMEVARYING", "file": "inlet.csv"}}}
...
class TestLoadConfig:
    ...
    def test_load_config_json(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            json.dump({"case_dir": "/path/to/case", "cardiac_cycle": 0.9, "visualization": {"fields": ["U"]}}, f)
            config_path = f.name
...
class TestDependencyReport:
    ...
    def test_add_dependencies(self):
        ...
        report = DependencyReport()
        report.dependencies["numpy"] = DependencyStatus(name="numpy", available=True, required=True)
...
class TestPostProcessorExceptions:
    ...
    def test_missing_field_error(self):
        ...
        error = MissingFieldError(
            "wallShearStressMean", required_for="TAWSS calculation", hint="Enable fieldAverage in controlDict"
        )
    ...
    def test_configuration_error(self):
        ...
        error = ConfigurationError(
            "Invalid time_steps value", value="invalid", valid_options="None, 'last', 'peak', or list"
        )
    ...
    def test_hemodynamics_error(self):
        ...
        error = HemodynamicsError("Calculation failed", metric="OSI", reason="Division by zero")
...
class TestColorRangeHandling:
    ...
    @pytest.mark.skipif(
        not PARAVIEW_MODULE_AVAILABLE, reason="ParaView Python module not available - post_processor requires paraview"
    )
...
class TestPydanticValidation:
    ...
    def test_visualization_schema_valid_fields(self):
        ...
        try:
            ...
            schema = VisualizationSchema(fields=["U", "p", "TAWSS"], time_steps="last", fps=30)
    ...
    def test_color_ranges_validation(self):
        ...
        try:
            ...
            # Valid color ranges
            schema = VisualizationSchema(color_ranges={"WSS": [0, 50], "OSI": [0, 0.5]})
            ...
            yaml.dump(
                {
                    "case_dir": "/yaml/case",
                    "cardiac_cycle": 0.95,
                    "visualization": {"fields": ["U", "wallShearStress"]},
                },
                f,
            )
            config_path = f.name
...
class TestValidateConfig:
    ...
    def test_validate_config_pydantic(self):
        ...
        config_dict = {
            ...
            "cardiac_cycle": 0.8,
            "verbosity": 1,
            "visualization": {"fields": ["U", "p"], "fps": 30},
        }
    ...
    def test_validate_config_without_pydantic(self):
        ...
        with patch("aortacfd_lib.post_processing.config.HAS_PYDANTIC", False):
            ...
            config_dict = {"visualization": {"time_steps": "last"}}
    ...
    def test_validate_config_invalid_time_steps_fallback(self):
        ...
        with patch("aortacfd_lib.post_processing.config.HAS_PYDANTIC", False):
            config_dict = {"visualization": {"time_steps": "invalid_value"}}
...
class TestPydanticSchemas:
    ...
    def test_post_processing_schema_full(self):
        ...
        schema = PostProcessingSchema(case_dir="/path/to/case", cardiac_cycle=0.9, verbosity=2)
...
class TestConfigFromDictAlternativePaths:
    ...
    def test_from_dict_post_processing_nested(self):
        ...
        data = {
            "post_processing": {
                "visualization": {"fields": ["p"], "fps": 25},
                "output": {"output_dir": "nested_output"},
            }
        }
    ...
    def test_from_dict_rescale_settings(self):
        ...
        data = {"visualization": {"rescale_settings": {"WSS": {"rescaleToData": False, "rescaleRange": [0, 100]}}}}
    ...
    def test_from_dict_geometry(self):
        ...
        data = {"geometry": {"case_name": "TestCase", "outlet_keywords_ordered": ["outlet1", "outlet2"]}}
...
class TestCLIConfigLoading:
    ...
    def test_load_config_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(config_path, "w") as f:
                json.dump({"cardiac_cycle": 1.0, "visualization": {"fields": ["U"]}}, f)
    ...
    def test_config_overrides_from_cli(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_path = os.path.join(temp_dir, "config.json")
            with open(config_path, "w") as f:
                json.dump({"visualization": {"fields": ["U", "p"]}}, f)
...
class TestCLIConfigWithOutput:
    ...
    def test_config_with_output_override(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_path = os.path.join(temp_dir, "config.json")
            with open(config_path, "w") as f:
                json.dump({"output": {"output_dir": "config_output"}}, f)
...
class TestDependencyReportPrint:
    ...
    def test_print_report_all_available(self, capsys):
        ...
        report = DependencyReport()
        report.dependencies["numpy"] = DependencyStatus(name="numpy", available=True, version="1.24.0", required=True)
    ...
    def test_print_report_missing_dependencies(self, capsys):
        ...
        report.dependencies["numpy"] = DependencyStatus(
            name="numpy", available=False, required=True, purpose="Array operations", install_hint="pip install numpy"
        )
...
class TestCheckExecutableExtended:
    ...
    def test_check_executable_version_parsing(self):
        ...
        with patch("shutil.which", return_value="/usr/bin/test_exe"):
            with patch("subprocess.run") as mock_run:
                mock_run.return_value = MagicMock(stdout="test_exe version 2.5.1\n", stderr="")
    ...
    def test_check_executable_version_from_stderr(self):
        ...
        with patch("shutil.which", return_value="/usr/bin/test_exe"):
            with patch("subprocess.run") as mock_run:
                mock_run.return_value = MagicMock(stdout="", stderr="test_exe 1.2.3\n")
...
class TestConfigFromDictAutoDetect:
    ...
    def test_from_dict_auto_detect_false(self):
        ...
        data = {"visualization": {"auto_detect_case_type": False}}
...
class TestConfigFromDictOutputSettings:
    ...
    def test_from_dict_output_log_file(self):
        ...
        data = {"output": {"log_file": "custom.log"}}
    ...
    def test_from_dict_output_pressure_plots(self):
        ...
        data = {"output": {"pressure_plots": False}}
...
class TestVisualizationConfigColorPresets:
    ...
    def test_from_dict_color_presets(self):
        ...
        data = {"visualization": {"color_presets": {"U": "Cool to Warm", "WSS": "Plasma"}}}
...
class TestHemodynamicsSchemaExtraFields:
    ...
    def test_hemodynamics_schema_extra_fields(self):
        ...
        schema = HemodynamicsSchema(skip_cycles=2, custom_field="test")
...
class TestFoamPostProcessVersionParsing:
    ...
    def test_openfoam_version_parsing(self):
        ...
        with patch("aortacfd_lib.post_processing.dependencies.check_executable") as mock_check:
            ...
            with patch("subprocess.run") as mock_run:
                mock_run.return_value = MagicMock(stdout="", stderr="Usage: foamPostProcess ... OpenFOAM v2312")
...
class TestPostProcessorFromConfig:
    ...
    def test_from_config_basic(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config_path = os.path.join(temp_dir, "config.json")
            with open(config_path, "w") as f:
                json.dump({"case_dir": temp_dir, "cardiac_cycle": 0.9}, f)
...
class TestPostProcessorRunAll:
    ...
    def test_run_all_hemodynamics_only(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"output": {"hemodynamics_report": True, "screenshots": False, "animations": False}}
    ...
    def test_run_all_visualization_without_paraview(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"output": {"hemodynamics_report": False, "screenshots": True, "animations": False}}
    ...
    def test_run_all_animations_without_ffmpeg(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"output": {"hemodynamics_report": False, "screenshots": False, "animations": True}}
...
class TestPostProcessorRunHemodynamics:
    ...
    def test_run_hemodynamics_basic(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"hemodynamics": {"run_wss_postprocess": False}, "output": {"hemodynamics_report": False}}
    ...
    def test_run_hemodynamics_runs_wss_postprocess(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"hemodynamics": {"run_wss_postprocess": True}, "output": {"hemodynamics_report": False}}
    ...
    def test_run_hemodynamics_generates_report(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"hemodynamics": {"run_wss_postprocess": False}, "output": {"hemodynamics_report": True}}
