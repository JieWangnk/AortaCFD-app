...
class TestMurrayFlowSplit:
    ...
    def test_calculate_murray_flow_split_equal_radii(self, mock_logger):
        ...
        config = {
            'geometry': {'case_name': 'test', 'inlet_keywords_ordered': 'inlet', 'outlet_keywords_ordered': ['o1', 'o2']},
            'boundary_conditions': {
                'inlet': {},
                'outlets': {'type': '3EWINDKESSEL', 'windkessel_settings': {}}
            }
        }
...
class TestParseCustomFlowSplit:
    ...
    def test_parse_complete_ratios(self, mock_logger):
        ...
        config = {
            'geometry': {'case_name': 'test', 'inlet_keywords_ordered': 'inlet', 'outlet_keywords_ordered': ['o1', 'o2', 'o3']},
            'boundary_conditions': {
                'inlet': {},
                'outlets': {'type': '3EWINDKESSEL', 'windkessel_settings': {}}
            }
    ...
    def test_parse_branches_percentage(self, mock_logger):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = wk._parse_flow_split_percentage(
                70, outlet_patches, 'area', outlet_radii
            )
...
class TestNormalizeDataType:
    ...
    def test_normalize_flowrate_variations(self, mock_logger):
        ...
        config = {
            ...
            'boundary_conditions': {
                'inlet': {},
                'outlets': {'type': '', 'windkessel_settings': {}}
            }
        }
