...
class TestMeshQualityTier:
    ...
    def test_tier_comparison(self):
        ...
        tiers = [MeshQualityTier.EXCELLENT, MeshQualityTier.GOOD,
                 MeshQualityTier.FAIR, MeshQualityTier.POOR, MeshQualityTier.CRITICAL]
...
class TestGetQualityTier:
    ...
    def test_excellent_tier(self, mock_logger):
        ...
        from aortacfd_lib.utils.mesh_quality import (
            MeshQualityAnalyzer, MeshQualityMetrics, MeshQualityTier
        )
    ...
    def test_fair_tier(self, mock_logger):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            metrics = MeshQualityMetrics(
                max_skewness=3.5,
                max_non_orthogonality=68.0,
                max_aspect_ratio=45.0,
                max_volume_ratio=40.0,
                mesh_ok=True
            )
    ...
    def test_poor_tier(self, mock_logger):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            metrics = MeshQualityMetrics(
                max_skewness=5.0,
                max_non_orthogonality=73.0,
                max_aspect_ratio=80.0,
                max_volume_ratio=80.0,
                mesh_ok=True
            )
    ...
    def test_critical_tier_from_mesh_not_ok(self, mock_logger):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            metrics = MeshQualityMetrics(
                max_skewness=1.0,  # Good metrics but mesh failed
                max_non_orthogonality=50.0,
                mesh_ok=False
            )
...
class TestMassBalanceCheckerInstantaneous:
    ...
    def test_check_balanced(self, mock_logger):
        ...
        outlet_flows = {
            'outlet1': 4e-5,  # 40 mL/s
            'outlet2': 3e-5,  # 30 mL/s
            'outlet3': 3e-5   # 30 mL/s
        }
    ...
    def test_check_unbalanced(self, mock_logger):
        ...
        outlet_flows = {
            'outlet1': 4e-5,
            'outlet2': 3e-5  # Missing 30% of flow
        }
