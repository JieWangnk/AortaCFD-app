...
class TestDeepMerge:
    ...
    def test_nested_merge(self):
        ...
        dest = {"physics": {"density": 1060, "viscosity": 0.004}}
        source = {"physics": {"temperature": 37}}
        result = deep_merge(dest, source)
    ...
    def test_deep_override(self):
        ...
        dest = {"mesh": {"resolution": "coarse", "refinement": {"level": 2}}}
        source = {"mesh": {"resolution": "fine", "refinement": {"maxLevel": 5}}}
        result = deep_merge(dest, source)
...
class TestConfigValidation:
    ...
    def test_openfoam_12_settings_applied(self):
        ...
        config = {"simulation_settings": {"openfoam_version": 12}}
...
class TestCaseDiscovery:
    ...
    def test_discover_case_with_boundary_conditions_json(self):
        ...
        bc_data = {"boundary_conditions": {"inlet": {"type": "flowRate", "value": 5.0}}}
...
class TestConvertUnifiedConfig:
    ...
    def test_convert_unified_config_basic(self):
        ...
        case_config = {"mesh": {"resolution_level": "medium"}, "physics": {"model": "laminar"}}

        converted = self.builder._convert_unified_config(case_name, case_config, cad_root_dir=self.temp_dir)
    ...
    def test_convert_missing_case_directory(self):
        ...
        with pytest.raises(FileNotFoundError):
            self.builder._convert_unified_config("missing_case", {}, cad_root_dir=self.temp_dir)
...
class TestWarningSystem:
    ...
    def test_warn_if_no_explicit_mesh(self):
        ...
        case_config = {"physics": {"model": "laminar"}}
    ...
    def test_no_warn_with_explicit_mesh(self):
        ...
        case_config = {"mesh": {"cells_per_diameter": 15}}
