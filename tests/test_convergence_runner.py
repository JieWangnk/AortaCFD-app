...
class TestApplySteadyBC:
    ...
    def test_converts_time_varying_to_constant(self):
        ...
        config = {
            ...
            "boundary_conditions": {"inlet": {"type": "TIMEVARYING"}, "outlets": {}},
            "physics": {},
            "numerics": {},
        }
    ...
    def test_sets_fixed_pressure_outlets(self):
        ...
        config = {
            "case_info": {"patient_id": "PAT001"},
            "boundary_conditions": {"inlet": {"type": "CONSTANT"}, "outlets": {"type": "WINDKESSEL"}},
            "physics": {},
            "numerics": {},
        }
...
class TestComputeConvergenceMetrics:
    ...
    def test_computes_all_quantities(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            quantities = {
                "coarse": {"pressure_drop": 100.0, "avg_velocity": 0.5, "avg_wss": 1.5, "peak_wss": 3.5},
                "medium": {"pressure_drop": 102.0, "avg_velocity": 0.52, "avg_wss": 1.55, "peak_wss": 3.6},
                "fine": {"pressure_drop": 102.5, "avg_velocity": 0.525, "avg_wss": 1.57, "peak_wss": 3.62},
            }
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            convergence_metrics = {
                "pressure_drop": {
                    ...
                    "convergence_status": "monotonic_convergence",
                },
                "avg_velocity": {
                    "observed_order": 2.0,
                    "phi_exact": 0.53,
...
class TestMain:
    ...
    def test_main_with_args(self, mock_runner_class):
        ...
        mock_runner.run_convergence_study.return_value = {"study_dir": "/tmp/study", "report": "/tmp/report.md"}
