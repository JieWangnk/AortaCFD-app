    ...
    def check_system_resources(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                "system_ready": (
                    memory_available_gb >= self.min_memory_gb
                    and disk_free_gb >= self.min_disk_space_gb
                    and cpu_percent < 90
                ),
            }
    ...
    def validate_simulation_config(config: Dict) -> Dict[str, any]:
        ...
        if "mesh" in config:
            ...
            if isinstance(mesh_resolution, dict):
                resolution_value = mesh_resolution.get("blockmesh_resolution") or mesh_resolution.get(
                    "blockMesh_resolution"
                )
