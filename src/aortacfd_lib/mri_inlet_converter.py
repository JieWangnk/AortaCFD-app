...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Convert 4D MRI inlet velocity data to OpenFOAM boundaryData format")
    ...
    csv_parser.add_argument(
        "--dt", type=float, default=0.001, help="Time step between columns in seconds (default: 0.001)"
    )
    csv_parser.add_argument(
        "--points-scale",
        type=float,
    ...
    of_parser.add_argument(
        "--dt", type=float, default=0.001, help="Time step between files in seconds (default: 0.001)"
    )
    of_parser.add_argument("--prefix", default="U", help="Velocity file prefix (default: U)")
