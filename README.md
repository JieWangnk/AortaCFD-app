...
- **Flexible Steps** - Run individual workflow steps (case/mesh/boundary/solver/reconstruct/postprocess/paraview)
...
# Run ParaView visualization on completed simulation
python run_patient.py BPM120 --update output/BPM120/run_20251220_093653 --steps paraview
...
python run_patient.py BPM120 --steps postprocess       # Compute hemodynamics + export QoIs
python run_patient.py BPM120 --steps paraview          # ParaView visualization
...
| **postprocess** | Compute hemodynamics (WSS, TAWSS, OSI, RRT) + export QoIs | After solver completes |
| **paraview** | Execute ParaView visualization | Generate screenshots/images |
...
python run_patient.py BPM120 --update output/BPM120/hpc_run --steps reconstruct,postprocess,paraview
```
...
```bash
# Run ParaView visualization as part of workflow
python run_patient.py BPM120 --steps paraview

# Run ParaView on existing case
python run_patient.py BPM120 --update output/BPM120/run_20251220_093653 --steps paraview

# Include visualization in full workflow
python run_patient.py BPM120  # paraview runs automatically at end
```
...
**Note:** TAWSS, OSI, and RRT fields are generated by the hemodynamics post-processor. Run `--steps postprocess` to create them before visualization.
